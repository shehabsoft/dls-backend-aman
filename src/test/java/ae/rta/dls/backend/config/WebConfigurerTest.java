...
public class WebConfigurerTest {
    ...
    private static final String TEST_CORS_URL_TEMPLATE = "/api/test-cors";

    private static final String HEADER_ORIGIN_VALUE = "other.domain.com";
    ...
    public void testStartUpProdServletContext() throws ServletException {
        env.setActiveProfiles(EnvironmentConstants.SPRING_PROFILE_PRODUCTION);
    ...
    public void testStartUpDevServletContext() throws ServletException {
        env.setActiveProfiles(EnvironmentConstants.SPRING_PROFILE_DEVELOPMENT);
        webConfigurer.onStartup(servletContext);
    ...
    public void testCorsFilterOnApiPath() throws Exception {
        ...
        mockMvc.perform(
            options(TEST_CORS_URL_TEMPLATE)
                .header(HttpHeaders.ORIGIN, HEADER_ORIGIN_VALUE)
                .header(HttpHeaders.ACCESS_CONTROL_REQUEST_METHOD, "POST"))
            .andExpect(status().isOk())
            .andExpect(header().string(HttpHeaders.ACCESS_CONTROL_ALLOW_ORIGIN, HEADER_ORIGIN_VALUE))
