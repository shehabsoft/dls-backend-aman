package ae.rta.dls.backend.domain;
...
@Entity
@Table(name = "sys_entity_audit_event")
...
public class EntityAuditEvent implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "enaeSequenceGenerator")
    @SequenceGenerator(name = "enaeSequenceGenerator", sequenceName = "enae_seq", allocationSize = 1)
    private Long id;
